...
# 적 enemy 캐릭터
enemy = pygame.image.load("/Users/donghyeok/Documents/Programming/파이썬/Pygame_basic/enemy.png")
enemy_size = enemy.get_rect().size # 이미지의 크기를 구해옴
enemy_width = enemy_size[0]
enemy_hgith = enemy_size[1]
enemy_x_pos = (screen_width / 2) - (enemy_width / 2) # 화면 가로의 절반 크기에 해당하는 곳에 위치
enemy_y_pos = (screen_hight / 2) - (enemy_hgith / 2) #화면 세로 크기 가장 아래에 해당하는 곷에 위치
...
# 잠시 대기
pygame.time.delay(2000) # 2s delay
